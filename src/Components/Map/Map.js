...
const Map = ({ location }) => {
    useEffect(() => {
        ...
        new mapboxgl.Marker().setLngLat([-43.1729, -22.9068]).addTo(map);
        new mapboxgl.Marker().setLngLat([-0.205874, 5.614818]).addTo(map);
        new mapboxgl.Marker().setLngLat([2.349014, 48.8566]).addTo(map);
        new mapboxgl.Marker().setLngLat([-80.1918, 25.7617]).addTo(map);
